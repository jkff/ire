...
public class IntegrationTest {
    ...
    public void testPerformance() {
        ...
        sb.setCharAt(700003, '8');
        sb.setCharAt(700004, '0');
        sb.setCharAt(700005, '0');
        String s = sb.toString();

        PatternSet pat = RegexCompiler.compile(Arrays.asList(
                RegexParser.parse(".*007.*"),
                RegexParser.parse(".*800.*")));
